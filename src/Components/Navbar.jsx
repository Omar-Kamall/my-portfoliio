...
const Navbar = () => {
  ...
  return (
    <nav className="text-white h-10 w-full z-100 fixed">
          ...
          <div className="hidden lg:flex gap-5">
            ...
            {links.map((link) => (
              <HashLink
                smooth
                onClick={() => {
                  setActive(link.id), setactive(false);
                }}
                className={`text-[18px] hover:text-[#4A90E2] ${
                  active === link.id &&
                  !Active &&
            ...
            <Link
              ...
              className={`text-[18px] hover:text-[#4A90E2] ${
                location.pathname === "/projects" && "text-[#4A90E2]"
              } transition duration-300`}
            >
              PROJECTS
            </Link>
            ...
            <div className="flex flex-col gap-2 w-43 mt-2 bg-[#0A0F1F] border-1 border-gray-600 rounded-2xl p-5">
              ...
              {links.map((link) => (
                <HashLink
                  smooth
                  onClick={() => {
                    setActive(link.id), setBar(false), setactive(false);
                  }}
                  className={`text-[18px] hover:text-[#4A90E2] ${
                    active === link.id &&
                    location.pathname === "/" &&
