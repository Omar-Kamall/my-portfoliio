            ...
            {loading ? <div className='h-[100vh] flex items-center justify-center'><FadeLoader color='#FF6F91' /></div> :
                <div className={`container mx-auto px-[5%] ${props.className}`}>
                    ...
                    <div className="mt-10 text-center pb-20">
                        <Link to="/projects"><button className="text-[#FF6F91] border-2 shadow-2xl shadow-[#FF6F91] border-[#FF6F91] hover:text-[#4A90E2] hover:border-[#4A90E2] hover:shadow-[#4A90E2] py-2 px-7 transition duration-500 cursor-pointer rounded-3xl">Wiew All Projects</button></Link>
                    </div>
                </div>
            }
